...
class PathSimulator:
    ...
    def simulate_iid_paths(self, N: int) -> Tuple[np.ndarray, np.ndarray, np.ndarray, np.ndarray]:
    ...
    def run(self) -> Dict:
        ...
        if self.config.n_paths_iid > 0:
            ...
            returns_iid, signal_iid_actual, signal_iid, returns_iid_annual = self.simulate_iid_paths(
                self.config.n_simulations
            )
        ...
        returns_iid_selected = signal_iid_actual_selected = signal_iid_selected = returns_iid_annual_selected = None
        ...
        if self.config.n_paths_iid > 0:
            ...
            signal_iid_actual_selected = signal_iid_actual[:, idx_iid]
        ...
        self.results = {
            ...
            'signal_iid_actual': signal_iid_actual_selected,
